...
def getSingleDatasetFromHd5(hd5File, subDatasetName):
    # Open HDF file
    hdflayer = gdal.Open(hd5File, READ_METHOD)
    ...
    # Print some metadata
    meta_data = sub_dataset.GetMetadata()
...
dataset, sub_dataset_ouput_name = getSingleDatasetFromHd5(filename, constants.SELECTED_DATASET)
